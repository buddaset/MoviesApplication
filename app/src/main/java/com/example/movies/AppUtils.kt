...
class AppUtils(private val context: Context) {
    ...
    val fakeData: List<MovieItem> = listOf(
        ...
        MovieItem("Black Widow", "13+",R.drawable.movie_black_widow, false, 4, 38, 102, "Example overview movie. Fake data. Soon.", listOf(Actor("Actor1", R.drawable.holder_place) ,Actor("Actor2", R.drawable.holder_place) , Actor("Actor3", R.drawable.holder_place), Actor("Actor4", R.drawable.holder_place))),
        MovieItem("Wonder Woman 1984", "13+",R.drawable.movie_wonder_woman, false, 5, 74, 122, "Example overview movie. Fake data. Soon.", listOf(Actor("Actor1", R.drawable.holder_place) ,Actor("Actor2", R.drawable.holder_place) , Actor("Actor3", R.drawable.holder_place), Actor("Actor4", R.drawable.holder_place))),
